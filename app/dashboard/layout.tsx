      ...
      <div className="md:ml-64 fixed top-0 right-0 left-0 md:left-64 h-16 md:h-20 bg-white border-b border-gray-200 z-20">
        <div className="h-full px-4 md:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4 ml-4 md:ml-6">
            <button className="relative p-2 md:p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center">
            ...
            <button className="hidden sm:flex items-center gap-2 p-1 hover:bg-gray-100 rounded-lg transition-colors min-h-[44px]">
